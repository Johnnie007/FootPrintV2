...
//      //Breaking because endpoint needs id
//        User user2 = new User();
//        user2.setFirstName("Test");
//        user2.setLastName("Testing");
//        user2.setLifeStyle("Active");
//        user2.setFootPrint(123);
//        user2.setEmail("TA");
//        user2.setPassword("12353");
//
//
//        ResultActions responseUpdateUser= mockMvc.perform(put("/api/email")
//                .with(user(user2.getEmail()).password(user2.getPassword()))
//                .contentType(MediaType.APPLICATION_JSON)
